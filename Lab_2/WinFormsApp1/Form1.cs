...
namespace WinFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void btn_text_clear(object sender, EventArgs e)
        {
            try
            {
                textBox1.Clear();
        ...
        private void btn_text_del(object sender, EventArgs e)
        {
            textBox1.Clear();
        }
        ...
        private void btn_del_sym(object sender, EventArgs e)
        {
